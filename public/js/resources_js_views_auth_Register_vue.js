...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("el-card", { staticStyle: { width: "550px", height: "400px" } }, [
        _c(
          "div",
          { staticClass: "flexed-column justify-center" },
          [
            _c("div", [_c("span", [_vm._v("Register")])]),
            _vm._v(" "),
            _c(
              "el-form",
              {
                ref: "registerForm",
                attrs: { model: _vm.registerModel, rules: _vm.rules }
              },
              [
                _c(
                  "el-form-item",
                  ...
                  [
                    _c("el-input", {
                      attrs: { name: "name" },
                      model: {
                        value: _vm.registerModel.name,
                        callback: function($$v) {
                          _vm.$set(_vm.registerModel, "name", $$v)
                        },
                        expression: "registerModel.name"
                      }
                    })
                  ],
                  1
                ...
                _c(
                  ...
                  [
                    _c("el-input", {
                      attrs: { name: "email" },
                      model: {
                        value: _vm.registerModel.email,
                        callback: function($$v) {
                          _vm.$set(_vm.registerModel, "email", $$v)
                        },
                        expression: "registerModel.email"
                      }
                    })
                  ],
                  1
                ...
                _c(
                  ...
                  [
                    _c("el-input", {
                      ...
                      model: {
                        value: _vm.registerModel.password,
                        callback: function($$v) {
                          _vm.$set(_vm.registerModel, "password", $$v)
                        },
                        expression: "registerModel.password"
                      }
                    })
                  ],
                  1
                ...
                _c(
                  ...
                  [
                    _c("el-input", {
                      ...
                      model: {
                        value: _vm.registerModel.password_confirmation,
                        callback: function($$v) {
                          _vm.$set(
                            _vm.registerModel,
                        ...
                        expression: "registerModel.password_confirmation"
                      }
                    })
                  ],
                  1
